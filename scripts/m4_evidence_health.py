...
def render_markdown(payload: dict[str, Any]) -> str:
    lines = [
        ...
        f"- Authoritative methodology：`{payload.get('authoritative_methodology_fingerprint')}`",
        f"- Current methodology：`{payload.get('current_methodology_fingerprint')}`",
        f"- Methodology match：**{payload.get('current_methodology_matches_authoritative_chain')}**",
