...
BuildBundle = Callable[..., dict[str, Any]]
...
def run_daily_handoff_bundle(
    *,
    root: str | Path,
    pipeline_report: str | Path,
    output: str | Path,
    report: str | Path,
    builder: BuildBundle = build_daily_handoff_bundle,
    ...
    payload: dict[str, Any] = {
        "schema_version": HANDOFF_RUN_REPORT_SCHEMA_VERSION,
